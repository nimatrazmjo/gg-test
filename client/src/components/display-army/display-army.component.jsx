...
const DisplayArmy = ({ archers, spearmen, swordsmen }) => (
  <div className="mt-6 grid grid-cols-3 gap-12">
    ...
    <div>
      <h1 className="text-3xl font-medium text-gray-700 flex items-center gap-2">Spearman { spearmen ?<span className='text-xs bg-blue-600 text-white px-2 py-1 rounded-full'> {spearmen}</span>: ''}</h1>
